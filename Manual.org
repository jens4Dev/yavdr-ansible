...
- [[#roles][Roles]]
  ...
  - [[#autoinstall-dvb-firmware][autoinstall-dvb-firmware]]
...
#+begin_src yaml :tangle yavdr07-rpi.yml :padline no
---
...
**** openbox
***** autostart
#+BEGIN_SRC shell :tangle roles/yavdr-desktop/templates/openbox/autostart.j2 :mkdirp yes :shebang #!/usr/bin/dash
...
*** tasks
#+begin_src yaml :tangle roles/install-dvb-firmware/tasks/main.yml
---
...
#+END_SRC
*** defaults
#+BEGIN_SRC yaml :tangle roles/autoinstall-firmware/defaults/main.yml :padline no
...
- name: Firmware dvb-demod-si2168-b40-01.fw for Hauppauge WinTV HD Solo/Duo, PCTV 292e
  get_url:
    ...
    checksum: sha256:89e67a94aae0ed39d9735c8c5354882a8564196f7215e5bf8776b54948184592
...
#+BEGIN_SRC yaml :tangle roles/kodi/defaults/main.yml
kodi_as_flatpak: False
...
** hardware_facts.py
#+BEGIN_SRC python :tangle library/hardware_facts.py :shebang "#!/usr/bin/env python3"
...
#+END_SRC
** pci_facts.py
#+BEGIN_SRC python :tangle library/pci_facts.py :shebang "#!/usr/bin/env python3"
